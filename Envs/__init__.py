...
def _register_highway_envs():
    ...
    register(
        id="city-v0",
        entry_point="highway_env.envs.city_env:CityEnv",
    )
    # city_env.py
    register(
        id="city2-v0",
        entry_point="highway_env.envs.city2_env:City2Env",
    )
    # envtest.py
    register(
        id="test-v0",
        entry_point="highway_env.envs.envtest:testEnv",
    )
    register(
        id="RSU-v0",
        entry_point="highway_env.envs.envtest:RSU",
    )
    register(
        id="testSC-v0",
        entry_point="highway_env.envs.envSC:testEnvSC",
    )
    register(
        id="RSUSC-v0",
        entry_point="highway_env.envs.envSC:RSUSC",
    )
